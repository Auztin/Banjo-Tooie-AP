...
void pre_object_init(bt_object_t *obj) {
  ...
  switch (obj->objType) {
    ...
    case BT_OBJ_HONEYB:
      ...
      util_inject(UTIL_INJECT_RAW     , (u32)obj + 0x05D4, 0, 0); // dont play animation
      util_inject(UTIL_INJECT_RAW     , (u32)obj + 0x05E4, 0, 0); // dont play animation
      util_inject(UTIL_INJECT_RAW     , (u32)obj + 0x068C, 0, 0); // dont play animation
      util_inject(UTIL_INJECT_RAW     , (u32)obj + 0x06A4, 0, 0); // dont play animation
      util_inject(UTIL_INJECT_FUNCTION, (u32)obj + 0x0708, (u32)save_fake_set_honeyb, 0); // write to fake flags
      util_inject(UTIL_INJECT_FUNCTION, (u32)obj + 0x0C50, (u32)save_fake_has_honeyb, 0); // read fake flags
      break;
