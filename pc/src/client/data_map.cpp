...
std::map<int, std::string> MESSAGE_IDS =
{
    {1230753, "received Grip Grab"},
    {1230754, "received Breegull Blaster"},
    {1230755, "received Egg Aim"},
    {1230757, "received Bill Drill"},
    {1230758, "received Beak Bayonet"},
    {1230760, "received Airborne Egg Aiming"},
    {1230761, "received Split Up"},
    {1230764, "received Wing Whack"},
    {1230765, "received Talon Torpedo"},
    {1230766, "received Sub-Aqua Egg Aiming"},
    {1230774, "received Shack Pack"},
    {1230775, "received Glide"},
    {1230771, "received Snooze Pack"},
    {1230772, "received Leg Spring"},
    {1230773, "received Claw Clamber Boots"},
    {1230768, "received Springy Step Shoes"},
    {1230769, "received Taxi Pack"},
    {1230770, "received Hatch"},
    {1230762, "received Pack Whack"},
    {1230776, "received Sack Pack"},
    {1230777, "received Fast Swimming"},
    {1230800, "received Breegull Bash"},
    {1230802, "received Homing Eggs Toggle"},
    {1230779, "received Amaze-O-Gaze"},
    {1230780, "received Baby T-Rex Roar"},
    {1230810, "received Dive"},
    {1230811, "received Flight Pad"},
    {1230824, "received Ground Rat-a-tat Rap"},
    {1230814, "received Roll"},
    {1230822, "received Air Rat-a-tat Rap"},
    {1230825, "received Beak Barge"},
    {1230816, "received Tall Jump"},
    {1230818, "received Flutter"},
    {1230812, "received Flap Flip"},
    {1230817, "received Climb"},
    {1230815, "received Talon Trot"},
    {1230820, "received Beak Buster"},
    {1230819, "received Wonderwing"},
    {1230826, "received Stilt Stride"},
    {1230821, "received Turbo Trainers"},
    {1230827, "received Beak Bomb"},
    {1230813, "received Third Person Egg Shooting"},
    {1230855, "received Mumbo: Golden Goliath"},
    {1230856, "received Mumbo: Levitate"},
    {1230857, "received Mumbo: Power"},
    {1230858, "received Mumbo: Oxygenate"},
    {1230859, "received Mumbo: Enlarge"},
    {1230860, "received Mumbo: EMP"},
    {1230861, "received Mumbo: Life Force"},
    {1230862, "received Mumbo: Rain Dance"},
    {1230863, "received Mumbo: Heal"},
    {1230174, "received Humba: Stony"},
    {1230175, "received Humba: Detonator"},
    {1230176, "received Humba: Money Van"},
    {1230177, "received Humba: Sub"},
    {1230178, "received Humba: T-Rex"},
    {1230179, "received Humba: Washing Machine"},
    {1230180, "received Humba: Snowball"},
    {1230181, "received Humba: Bee"},
    {1230182, "received Humba: Dragon"},
    {1230794, "received IoH: Train Station"},
    {1230791, "received TDL: Train Station"},
    {1230790, "received GI: Train Station"},
    {1230792, "received HFP: Lava Side Train Station"},
    {1230793, "received HFP: Icy Side Train Station"},
    {1230795, "received WW: Train Station"},
    {1230796, "received Chuffy"},
    {1230944, "received Mayahem Temple"},
    {1230945, "received Glitter Gulch Mine"},
    {1230946, "received Witchyworld"},
    {1230947, "received Jolly Roger's Lagoon"},
    {1230948, "received Terrydactyland"},
    {1230949, "received Grunty Industries"},
    {1230950, "received Hailfire Peaks"},
    {1230951, "received Cloud Cuckooland"},
    {1230952, "received Cauldron Keep"},
    {-1, "received HAG-1"},
    {-2, "You have found enough Mumbo Tokens! Time to head home!"},
};
